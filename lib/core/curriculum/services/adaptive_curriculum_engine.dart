...
class AdaptiveCurriculumEngine {
  ...
  // =========================================================================
  // 9. CONTEXTUAL READING COMPREHENSION & ESSAY EXCERPT BUILDER
  // =========================================================================
  static ExerciseModel _buildStoryPassageForTopic(ConversationTopicMeta topic) {
    final loreStories = [
      {
        'chapter': 'Volumen I: The Great Vowel Shift and Linguistic Evolution',
        'prompt': 'Completa el pasaje del ensayo lingüístico:',
        'subtitle': 'Lectura crítica y análisis contextual en inglés',
        'leading': 'Between 1400 and 1700, the phonetic landscape of the British Isles underwent an unprecedented transformation known as the Great Vowel Shift. Historical linguists discovered that long vowel sounds shifted upward in pronunciation, which profoundly altered how scholars would',
        'trailing': 'ancient manuscripts and standardized spelling across centuries of literature.',
        'options': ['transcribe', 'ignore', 'discard', 'forget'],
        'answer': 'transcribe',
        'trick': 'Lectura Contextual: "Transcribe ancient manuscripts" es la colocación académica precisa.',
      },
      {
        'chapter': 'Volumen II: The Neuroscience of Spoken Fluency',
        'prompt': 'Analiza el fragmento de la revista de neurociencia:',
        'subtitle': 'Ciencia cognitiva y adquisición del lenguaje',
        'leading': 'Recent functional MRI research demonstrates that acquiring second language automaticity requires synaptic rewiring in Broca\'s area. Cognitive researchers emphasize that adult learners can dramatically accelerate neural pathway consolidation if they',
        'trailing': 'the speech patterns of native speakers through active daily shadowing drills.',
        'options': ['imitate', 'avoid', 'prohibit', 'dismiss'],
        'answer': 'imitate',
        'trick': 'Lectura Contextual: "Imitate the speech patterns" se enlaza directamente con el método de shadowing.',
      },
      {
        'chapter': 'Volumen III: The Voyager Golden Record and Universal Communication',
        'prompt': 'Descifra la crónica de la misión espacial interestelar:',
        'subtitle': 'Filosofía y comunicación universal en inglés',
        'leading': 'Aboard the Voyager 1 spacecraft, a gold-plated copper phonograph record drifts into the interstellar medium. Carl Sagan\'s curation committee selected fifty-five spoken greetings in human languages to ensure that any prospective extraterrestrial intelligence could',
        'trailing': 'the fundamental curiosity and peaceful intent of our civilization.',
        'options': ['comprehend', 'attack', 'eliminate', 'frighten'],
        'answer': 'comprehend',
        'trick': 'Lectura Contextual: "Comprehend the fundamental intent" (comprender la intención fundamental).',
      },
      {
        'chapter': 'Volumen IV: Architecture and Cognitive Thought',
        'prompt': 'Analiza el tratado sobre diseño espacial y pensamiento:',
        'subtitle': 'Arquitectura moderna y psicología humanista',
        'leading': 'The Bauhaus movement revolutionized human environments by demonstrating that architectural form directly governs psychological clarity. Walter Gropius asserted that modern public buildings must be intentionally structured to',
        'trailing': 'genuine human collaboration and spontaneous intellectual dialogue.',
        'options': ['foster', 'prevent', 'delay', 'oppose'],
        'answer': 'foster',
        'trick': 'Lectura Contextual: "Foster collaboration" (fomentar la colaboración) es una colocación formal vital.',
      },
      {
        'chapter': 'Volumen V: Deep Ocean Exploration and Bioluminescence',
        'prompt': 'Lee el extracto de la expedición oceanográfica:',
        'subtitle': 'Biología marina y fenómenos naturales',
        'leading': 'In the midnight zone three thousand meters beneath the Pacific, sunlight ceases entirely. Marine biologists aboard deep-submergence vessels discovered that over ninety percent of abyssal organisms produce enzymatic chemical light to',
        'trailing': 'their surrounding environment and deter apex predators.',
        'options': ['illuminate', 'extinguish', 'freeze', 'obscure'],
        'answer': 'illuminate',
        'trick': 'Lectura Contextual: "Illuminate their surrounding environment" (iluminar su entorno).',
      },
    ];
